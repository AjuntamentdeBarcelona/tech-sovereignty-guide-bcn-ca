...
La política referent a la sobirania tecnològica de l'Ajuntament es basa en els principis i directrius indicats en el Pla Barcelona Digital 2017–2020: Transició cap a la sobirania tecnològica, els estàndards de serveis digitals i el xref:{lang}/tech-practices:ROOT:aim-and-scope.adoc[Codi de pràctiques tecnològiques].
...
e.  Com a cas concret de desplegament d'aquestes directrius d'interoperabilitat, vegeu per exemple la http://hdl.handle.net/11703/84149[Política de gestió documental].
****
...
Dins d'aquestes línies generals, els principals elements d'aquesta política, recollits en el xref:{lang}/tech-practices:ROOT:aim-and-scope.adoc[Codi de pràctiques tecnològiques], s'exposen a continuació.
...
Aquests principis es concreten en les següents directrius recollides en el xref:{lang}/tech-practices:ROOT:aim-and-scope.adoc[Codi de pràctiques tecnològiques]:
