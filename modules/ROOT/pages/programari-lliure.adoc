...
. *Comunitats:* els drets concedits per les llicències permeten l'ús intensiu i la difusió massiva del programari lliure a través de les xarxes d'internet (sobretot a partir de repositoris com SourceForge o GitHub) i fomenten la creació de comunitats al vol-tant dels projectes de programari lliure.
