// tag::metadata[]
// IMPORTANT: el bloc següent (fins que aparegui "end::metadata[]") ha de ser
// continuo (no posar cap línia en blanc).
// OBLIGATORI. Asciidoctor suporta una etiqueta d'idioma,
...
:_public_repo_url: https://github.com/AjuntamentdeBarcelona/sobirania-tec-bcn-ca
//
// OBLIGATORI.
